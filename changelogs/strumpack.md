...
## Version 8.0.0-4 - Tue Sep 22 2026
- Release bump only, no recipe content change: rebuilt because openmpi, scotch, butterflypack, scalapack changed in the 2026-09-22 campaign (`todo/rebuild_campaign_20260922.md`). With `AutoReqProv: no` a rebuild at an unchanged NEVRA is invisible to dnf/apt, so the release is bumped.
